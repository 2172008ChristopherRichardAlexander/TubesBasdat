...
<div class="container">
<form method="POST" action=<?php echo "pabrik.php?q=".$_SESSION['userLogin'] ?>>
<table class="table table-striped table-dark table-bordered table-hover">
    <thead class="thead-dark">
        <tr>
            <th scope="col">#</th>
            <th scope="col">KodePabrik</th>
            <th scope="col">NamaPabrik</th>
    ...
    <tbody>
        ...
        while( $row = sqlsrv_fetch_array( $result, SQLSRV_FETCH_ASSOC) ) {
            ...
            echo "<td> <div> <button type='submit' class='btn btn-success'>Update</button> <button type='submit' value='".$row['KodePabrik']."' name='delete' class='btn btn-danger'>Delete</button> </div> </td>";
            echo "</tr>";
            $num = $num + 1;
        }   
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!-- FORMS -->
    <form class="form-horizontal" method="POST" action=<?php echo "pabrik.php?q=".$_SESSION['userLogin'] ?>>
        <div class="form-group">
            <label for="NamaPabrik" class="col-sm-2 control-label">NamaPabrik</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="NamaPabrik" name="NamaPabrik" placeholder="NamaPabrik">
                </div>
        </div>
        <div class="form-group">
...
function tambah() {
    ...
    $alamat = $_POST['Alamat'];
    $sql = "EXEC [dbo].[SP_AutoPabrik] '". $namapabrik. "', '" . $alamat . "'";
    $result = sqlsrv_query($conn, $sql);
    if ($result) {
...
function delete() {
    include ('../connect.php');
    $pk = $_POST['delete'];
    $sql = "DELETE FROM tbPabrik WHERE KodePabrik = '". $pk . "'";
    $result = sqlsrv_query($conn, $sql);
    if ($result) {
